...
const SCENES: Scene[] = [
  ...
  },
  {
    ...
    ms: 4600,
    kicker: "Security of data",
    title: "IP allowlisting — your network, your door",
  ...
  },
  {
    ...
    body: "Leaders get a live cockpit. Delivery stays governed. Security is not a slide — MFA, IP allowlist, BYOD, and tenant isolation are in the product.",
    Visual: (p) => (
...
export function LandingStoryWindow({ cfg }: { cfg: LandingConfig }) {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="iProjectX illustrated walkthrough"
      style={{
        borderColor: "rgba(255,255,255,0.12)",
