...
export function paletteToAppCssVars(
  ...
  return {
    ...
    /* Auth brand panel — kept in sync with landing palette */
    "--auth-panel-accent": palette.accent,
    "--auth-panel-navy": palette.navy,
    "--auth-panel-deep": "#0b1428",
...
export function applyPlatformThemeToDocument(
  ...
  opts: { forAuth: boolean; forApp: boolean; forPlatform?: boolean },
) {
