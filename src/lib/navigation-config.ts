...
export const DEFAULT_NAV_GROUPS: NavGroupDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/work-board", label: "Work Board", icon: "Columns3" },
      ...
      { to: "/app/stage-gates", label: "Stage Gates", icon: "Flag" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/budget-vs-plan", label: "Budget vs Plan", icon: "Table2" },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/report-builder", label: "Report Builder", icon: "FileSpreadsheet" },
