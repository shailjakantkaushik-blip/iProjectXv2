...
export const PALETTES: ChartPalette[] = [
  {
    ...
    description: "Balanced blues, greens and warm accents",
  ...
  },
  {
    id: "sunset",
    name: "Sunset",
    description: "Warm reds, oranges and purples",
    tokens: {
      ...DEFAULT_TOKENS,
      "rag-green": "#65a30d",
      "rag-amber": "#f97316",
  ...
  },
  {
    ...
    description: "Colorblind-friendly, single-hue ramp",
    tokens: {
      ...DEFAULT_TOKENS,
      "rag-green": "#075985",
      "rag-amber": "#0ea5e9",
...
export const PRIORITY_COLORS: Record<string, string> = {
  "P1 - Critical": v("priority-critical"),
  P1: v("priority-critical"),
  Critical: v("priority-critical"),
  "P2 - High": v("priority-high"),
  P2: v("priority-high"),
  High: v("priority-high"),
  "P3 - Medium": v("priority-medium"),
  P3: v("priority-medium"),
  Medium: v("priority-medium"),
  "P4 - Low": v("priority-low"),
  P4: v("priority-low"),
  Low: v("priority-low"),
};
...
export const DEP_STATUS_COLORS: Record<string, string> = {
  ...
  "At Risk": v("status-at-risk"),
  Blocked: v("status-blocked"),
};

export const RISK_STATUS_COLORS: Record<string, string> = {
  Open: v("status-rejected"),
  Mitigating: v("status-hold"),
  Accepted: v("chart-8"),
  Closed: v("rag-green"),
};
...
export const RELEASE_STATUS_COLORS: Record<string, string> = {
  Submitted: v("chart-8"),
  "In Review": v("status-review"),
  Approved: v("rag-green"),
  Rejected: v("status-rejected"),
  Deferred: v("status-hold"),
};
