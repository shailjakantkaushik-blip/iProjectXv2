...
export const PAGES: { path: string; label: string; group: string }[] = [
  { path: "/app/executive-cockpit", label: "Executive Cockpit", group: "Home" },
  { path: "/app/executive", label: "Executive Dashboard", group: "Home" },
  { path: "/app/latest-updates", label: "Latest Updates", group: "Home" },
  { path: "/app/about", label: "About", group: "Home" },
