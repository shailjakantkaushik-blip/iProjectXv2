...
-- =============================================================================
-- VERSION: 2 (2026-08-14) — if LINE ~84 is "role = _role" you have the OLD file.
-- Download fresh from branch cursor/repair-platform-ddl-503d.
--
...
--
-- If you only hit "operator does not exist: text = app_role", run JUST this first:
...
-- 3. Paste/run THIS VERSION 2 file (header must say VERSION: 2)
