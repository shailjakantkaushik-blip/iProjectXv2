...
--
-- SEEDS
--   10 projects with Core + second stream, 9 stage gates per stream,
...
DECLARE
  ...
  methods public.delivery_method[] := ARRAY['Hybrid','Agile','Waterfall','Hybrid','Agile','Waterfall','Hybrid','Agile','Waterfall','Hybrid'];
