...
DROP POLICY IF EXISTS "bu_read_org" ON public.business_units;
...
DROP POLICY IF EXISTS "bu_admin_write" ON public.business_units;
...
DROP TRIGGER IF EXISTS trg_bu_updated ON public.business_units;
...
DROP POLICY IF EXISTS "org read stage_gates" ON public.stage_gates;
...
DROP POLICY IF EXISTS "editors modify stage_gates" ON public.stage_gates;
...
DROP TRIGGER IF EXISTS trg_stage_gates_updated ON public.stage_gates;
...
DROP POLICY IF EXISTS "org read milestones" ON public.milestones;
...
DROP POLICY IF EXISTS "editors modify milestones" ON public.milestones;
...
DROP POLICY IF EXISTS "org read actions" ON public.actions;


CREATE POLICY "org read actions" ON public.actions FOR SELECT TO authenticated USING (org_id = public.get_user_org(auth.uid()));

DROP POLICY IF EXISTS "editors modify actions" ON public.actions;
...
DROP POLICY IF EXISTS "org read decisions" ON public.decisions;
...
DROP POLICY IF EXISTS "editors modify decisions" ON public.decisions;
...
DROP POLICY IF EXISTS "org read dependencies" ON public.dependencies;
...
DROP POLICY IF EXISTS "editors modify dependencies" ON public.dependencies;


CREATE POLICY "editors modify dependencies" ON public.dependencies FOR ALL TO authenticated
  USING (public.can_edit_project(auth.uid(), project_id)) WITH CHECK (public.can_edit_project(auth.uid(), project_id));

DROP TRIGGER IF EXISTS trg_dependencies_updated ON public.dependencies;
...
DROP POLICY IF EXISTS "org read change_requests" ON public.change_requests;
...
DROP POLICY IF EXISTS "editors modify change_requests" ON public.change_requests;


CREATE POLICY "editors modify change_requests" ON public.change_requests FOR ALL TO authenticated
  USING (public.can_edit_project(auth.uid(), project_id)) WITH CHECK (public.can_edit_project(auth.uid(), project_id));

DROP TRIGGER IF EXISTS trg_change_requests_updated ON public.change_requests;
...
DROP POLICY IF EXISTS "org read fy_allocations" ON public.fy_allocations;
...
DROP POLICY IF EXISTS "editors modify fy_allocations" ON public.fy_allocations;


CREATE POLICY "editors modify fy_allocations" ON public.fy_allocations FOR ALL TO authenticated
  USING (public.can_edit_project(auth.uid(), project_id)) WITH CHECK (public.can_edit_project(auth.uid(), project_id));

DROP TRIGGER IF EXISTS trg_fy_allocations_updated ON public.fy_allocations;
...
DROP POLICY IF EXISTS "org read financials_monthly" ON public.financials_monthly;
...
DROP POLICY IF EXISTS "editors modify financials_monthly" ON public.financials_monthly;


CREATE POLICY "editors modify financials_monthly" ON public.financials_monthly FOR ALL TO authenticated
  USING (public.can_edit_project(auth.uid(), project_id)) WITH CHECK (public.can_edit_project(auth.uid(), project_id));

DROP TRIGGER IF EXISTS trg_financials_monthly_updated ON public.financials_monthly;
...
DROP POLICY IF EXISTS "org read benefits" ON public.benefits;


CREATE POLICY "org read benefits" ON public.benefits FOR SELECT TO authenticated USING (org_id = public.get_user_org(auth.uid()));

DROP POLICY IF EXISTS "editors modify benefits" ON public.benefits;
...
DROP POLICY IF EXISTS "org read sprints" ON public.sprints;


CREATE POLICY "org read sprints" ON public.sprints FOR SELECT TO authenticated USING (org_id = public.get_user_org(auth.uid()));

DROP POLICY IF EXISTS "editors modify sprints" ON public.sprints;
...
DROP POLICY IF EXISTS "admins modify resources" ON public.resources;
...
DROP POLICY IF EXISTS "org read resource_allocations" ON public.resource_allocations;
...
DROP POLICY IF EXISTS "editors modify resource_allocations" ON public.resource_allocations;


CREATE POLICY "editors modify resource_allocations" ON public.resource_allocations FOR ALL TO authenticated
  USING (public.can_edit_project(auth.uid(), project_id)) WITH CHECK (public.can_edit_project(auth.uid(), project_id));

DROP TRIGGER IF EXISTS trg_resource_allocations_updated ON public.resource_allocations;
...
DROP POLICY IF EXISTS "org read stakeholders" ON public.stakeholders;
...
DROP POLICY IF EXISTS "editors modify stakeholders" ON public.stakeholders;
...
DROP POLICY IF EXISTS "org read status_updates" ON public.status_updates;
...
DROP POLICY IF EXISTS "editors modify status_updates" ON public.status_updates;


CREATE POLICY "editors modify status_updates" ON public.status_updates FOR ALL TO authenticated
  USING (public.can_edit_project(auth.uid(), project_id)) WITH CHECK (public.can_edit_project(auth.uid(), project_id));

DROP TRIGGER IF EXISTS trg_status_updates_updated ON public.status_updates;
...
DROP POLICY IF EXISTS "org read lessons_learned" ON public.lessons_learned;
...
DROP TRIGGER IF EXISTS trg_lessons_learned_updated ON public.lessons_learned;
...
DROP POLICY IF EXISTS "org read demand_pipeline" ON public.demand_pipeline;
...
DROP TRIGGER IF EXISTS trg_demand_pipeline_updated ON public.demand_pipeline;
...
DROP POLICY IF EXISTS "org read portfolio_scenarios" ON public.portfolio_scenarios;
...
DROP POLICY IF EXISTS "admins write portfolio_scenarios" ON public.portfolio_scenarios;
...
DROP TRIGGER IF EXISTS trg_portfolio_scenarios_updated ON public.portfolio_scenarios;
...
DROP POLICY IF EXISTS "org read scenario_projects" ON public.scenario_projects;
...
DROP POLICY IF EXISTS "admins write scenario_projects" ON public.scenario_projects;
...
DROP TRIGGER IF EXISTS trg_scenario_projects_updated ON public.scenario_projects;
...
DROP POLICY IF EXISTS "Members view org stage gate defs" ON public.stage_gate_definitions;
...
DROP POLICY IF EXISTS "Admins manage org stage gate defs" ON public.stage_gate_definitions;
...
DROP TRIGGER IF EXISTS trg_stage_gate_definitions_updated_at ON public.stage_gate_definitions;
...
DROP POLICY IF EXISTS "plans readable by all" ON public.billing_plans;


CREATE POLICY "plans readable by all" ON public.billing_plans FOR SELECT USING (true);

DROP POLICY IF EXISTS "plans manage platform" ON public.billing_plans;


CREATE POLICY "plans manage platform" ON public.billing_plans FOR ALL
  USING (public.is_platform_admin(auth.uid())) WITH CHECK (public.is_platform_admin(auth.uid()));

DROP TRIGGER IF EXISTS trg_plans_updated ON public.billing_plans;
...
DROP POLICY IF EXISTS "sub view own or platform" ON public.subscriptions;
...
DROP POLICY IF EXISTS "sub manage platform" ON public.subscriptions;
...
DROP POLICY IF EXISTS "inv view own or platform" ON public.invoices;


CREATE POLICY "inv view own or platform" ON public.invoices FOR SELECT
  USING (org_id = public.get_user_org(auth.uid()) OR public.is_platform_admin(auth.uid()));

DROP POLICY IF EXISTS "inv manage platform" ON public.invoices;
...
DROP POLICY IF EXISTS "pay view own or platform" ON public.invoice_payments;
...
DROP POLICY IF EXISTS "pay insert platform" ON public.invoice_payments;
...
DROP POLICY IF EXISTS "expenses platform only" ON public.platform_expenses;


CREATE POLICY "expenses platform only" ON public.platform_expenses FOR ALL
  USING (public.is_platform_admin(auth.uid())) WITH CHECK (public.is_platform_admin(auth.uid()));

DROP TRIGGER IF EXISTS trg_exp_updated ON public.platform_expenses;
...
DROP POLICY IF EXISTS "notif insert platform or self" ON public.notifications;
...
DROP POLICY IF EXISTS "Org members can view channels" ON public.governance_channels;
...
DROP POLICY IF EXISTS "Org admins can delete channels" ON public.governance_channels;
...
DROP TRIGGER IF EXISTS trg_governance_channels_updated_at ON public.governance_channels;
...
DROP TRIGGER IF EXISTS trg_landing_config_updated ON public.landing_config;
...
DROP TRIGGER IF EXISTS trg_invoice_template_config_updated ON public.invoice_template_config;
...
DROP POLICY IF EXISTS "org read work_items" ON public.work_items;
...
DROP POLICY IF EXISTS "editors modify work_items" ON public.work_items;
...
DROP POLICY IF EXISTS "purge_notices_platform_all" ON public.project_purge_notices;
...
DROP POLICY IF EXISTS "purge_notices_org_select" ON public.project_purge_notices;
...
DROP POLICY IF EXISTS "purge_notices_org_insert" ON public.project_purge_notices;
...
DROP POLICY IF EXISTS "purge_notices_org_update" ON public.project_purge_notices;
...
DROP POLICY IF EXISTS "eoi_select_platform_admin" ON public.eoi_requests;
...
DROP POLICY IF EXISTS "eoi_update_platform_admin" ON public.eoi_requests;
...
DROP POLICY IF EXISTS "cert_platform_admin_all" ON public.org_license_certificates;
...
DROP POLICY IF EXISTS "policies_platform_admin_all" ON public.legal_policies;
...
DROP POLICY IF EXISTS "policies_public_select" ON public.legal_policies;
...
DROP POLICY IF EXISTS "org_support_settings_platform_all" ON public.org_support_settings;
...
DROP POLICY IF EXISTS "org_support_settings_org_select" ON public.org_support_settings;
...
DROP POLICY IF EXISTS "support_tickets_org_select" ON public.support_tickets;
...
DROP POLICY IF EXISTS "support_tickets_org_insert" ON public.support_tickets;
...
DROP POLICY IF EXISTS "support_comments_platform_all" ON public.support_ticket_comments;
...
DROP POLICY IF EXISTS "support_comments_org_select" ON public.support_ticket_comments;
...
DROP POLICY IF EXISTS "support_comments_org_insert" ON public.support_ticket_comments;
...
DROP POLICY IF EXISTS "org read work_item_assignees" ON public.work_item_assignees;
...
DROP POLICY IF EXISTS "editors modify work_item_assignees" ON public.work_item_assignees;
...
DROP POLICY IF EXISTS "owner insert timesheets" ON public.timesheets;
...
DROP POLICY IF EXISTS "owner update draft timesheets" ON public.timesheets;
...
DROP POLICY IF EXISTS "owner delete draft timesheets" ON public.timesheets;
...
DROP POLICY IF EXISTS "owner modify timesheet_entries" ON public.timesheet_entries;
...
DROP POLICY IF EXISTS "read timesheet_approvals" ON public.timesheet_approvals;
...
DROP POLICY IF EXISTS "approver update timesheet_approvals" ON public.timesheet_approvals;
...
DROP POLICY IF EXISTS "system insert timesheet_approvals" ON public.timesheet_approvals;
