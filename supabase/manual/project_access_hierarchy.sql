...
-- Also isolates platform_admin from tenant PMO data (see the block at the end).
...
GRANT EXECUTE ON FUNCTION public.user_has_tenant_org_role(uuid, uuid) TO authenticated;
