...
-- Generated: 2026-08-14T15:29:50.421Z
-- =============================================================================
--
-- WHAT THIS FILE CONTAINS
--   1) Full schema from 75 migrations
...
-- -----------------------------------------------------------------------------
-- migration: 20260720095542_fe684dfb-a86c-4dee-8677-269ef34d6e6d.sql
-- -----------------------------------------------------------------------------
-- ============ ENUMS ============
...
-- -----------------------------------------------------------------------------
-- migration: 20260720142651_ea675b15-ef58-490e-bbc1-84ee7dfe5be8.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720154945_bad56956-d8c1-4ad3-b352-910507778ecd.sql
-- -----------------------------------------------------------------------------
ALTER TABLE public.projects ADD COLUMN IF NOT EXISTS brief JSONB NOT NULL DEFAULT '{}'::jsonb;


-- -----------------------------------------------------------------------------
-- migration: 20260720160157_e35e7e88-c0c4-48a4-ad57-285fb894e0f5.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720161305_80583084-2147-4dac-a3b3-4175b3fbcf09.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720170906_397014ad-185f-4ef0-b550-81761bfdf749.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720173551_6b8aab86-e9f5-4050-865b-12bb5e21abb9.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720175729_db652369-8193-4b5e-9854-f4645cf5c144.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720182224_b6139dec-7ab6-451b-b48f-94836ca6964a.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720183419_b0b07096-1200-4dcc-9176-c729ef5a7394.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720183914_d339a828-5500-4290-a403-83b00d137037.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720184306_b3564da7-a7df-48fa-a725-1d97f96b7dd8.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720185715_a9a80e49-6b8d-4760-91d9-7a82f8d12366.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720190943_16e46bed-def4-4d08-9101-3bfd417aadf1.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720193242_86ab4966-ea3c-4aed-935c-d9aae73e7075.sql
-- -----------------------------------------------------------------------------
ALTER TABLE public.organizations
...
-- -----------------------------------------------------------------------------
-- migration: 20260720195543_fbbd6dca-b4e8-471c-b050-203ca74c1b3f.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720203156_78a0313f-14ad-4024-879e-97d4c714a09a.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260720205726_5d2e27a2-a78b-407c-a197-fd6d7d00f57c.sql
-- -----------------------------------------------------------------------------
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS must_change_password boolean NOT NULL DEFAULT false;


-- -----------------------------------------------------------------------------
-- migration: 20260721003000_invoice_template_config.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721004500_fix_landing_invoice_grants.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721020000_decision_approver_notifications.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721030000_advanced_pmo_work_baselines.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721080000_org_ui_config.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721090000_role_project_visibility.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721100000_user_role_project_visibility.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721110000_fix_user_roles_unique.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721120000_user_active_admin_management.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721130000_project_purge_notices.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721140000_sync_project_phase_and_schedule.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721150000_platform_admin_org_scoped_projects.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260721160000_fy_forecast_and_project_fac.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260722090000_sync_milestones_from_stage_gates.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724120000_project_streams.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724140000_always_on_core_streams.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724180000_eoi_and_licenses_policies.sql
-- -----------------------------------------------------------------------------
-- ============================================================
...
-- -----------------------------------------------------------------------------
-- migration: 20260724190000_work_items_stream_id.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724193000_grant_eoi_licenses_policies.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724194500_publish_legal_policies.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724200000_iprojectx_legal_policy_bodies.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724210000_support_tickets.sql
-- -----------------------------------------------------------------------------
-- ============================================================
...
-- -----------------------------------------------------------------------------
-- migration: 20260724220000_projects_portfolio.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260724230000_ensure_decision_approver_columns.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260725120000_security_hardening.sql
-- -----------------------------------------------------------------------------
-- ============================================================
...
-- -----------------------------------------------------------------------------
-- migration: 20260725160000_security_events_and_eoi_revoke.sql
-- -----------------------------------------------------------------------------
-- ============================================================
...
-- -----------------------------------------------------------------------------
-- migration: 20260725170000_audit_events_admin_read.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260725190000_org_inhouse_ai_model_enabled.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260725193000_org_sso_config.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260726093000_scope_admin_roles_to_home_org.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260726120000_page_download_ui_config.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729120000_org_byod_connections.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729180000_timesheets.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729193000_roles_timesheet_cost.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729210000_timesheet_reporting_audit.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729220000_work_item_resource_assignees.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729230000_profile_resource_sync_labor.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729240000_work_item_stage_gates_stream_only.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729250000_fix_text_app_role_ops.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729260000_resource_alloc_stage_gate_labor_idempotent.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729270000_timesheet_cost_pm_access.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260729280000_timesheet_reopen_approver_history.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260730120000_opex_labor_planned.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260730130000_fix_timesheet_rls_recursion.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260730140000_opex_other_costs.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260730150000_work_items_sprint_id.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260730160000_ppm_platform_depth.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260731120000_org_integrations.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260801120000_stakeholder_user_sponsor.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260801140000_org_ip_restriction.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260804120000_scale_hardening.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260807120000_executive_intelligence.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260807140000_stage_gate_checklist_governance.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260807150000_fix_kpi_refresh_enum_coalesce.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260814150000_delivery_methods_stage_gates.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260814170000_raid_escalation_and_alert_digests.sql
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- migration: 20260814180000_security_hardening_rls_rate_acl.sql
-- -----------------------------------------------------------------------------
...
-- #############################################################################
-- =============================================================================
-- iProjectX — Platform control-plane baseline seed
-- =============================================================================
-- Use when org / project / user data already exists but platform screens are empty:
--   Plans, Subscriptions, Limits, Landing, Invoice Template, Policies,
--   Expenses, Finance, All Invoices.
--
-- Safe / idempotent: ON CONFLICT / NOT EXISTS guards. Does NOT wipe org data.
--
-- Prerequisites: full schema already applied
--   (supabase/manual/iprojectx_full_platform_schema.sql or migrations)
--
-- Run in Supabase SQL Editor as postgres / service_role.
-- =============================================================================

-- Quick inventory (read-only) — see what is already present
DO $$
BEGIN
  RAISE NOTICE 'billing_plans: %', (SELECT count(*) FROM public.billing_plans);
  RAISE NOTICE 'legal_policies: %', (SELECT count(*) FROM public.legal_policies);
  RAISE NOTICE 'landing_config: %', (SELECT count(*) FROM public.landing_config);
  RAISE NOTICE 'invoice_template_config: %', (SELECT count(*) FROM public.invoice_template_config);
  RAISE NOTICE 'platform_expenses: %', (SELECT count(*) FROM public.platform_expenses);
...
-- =============================================================================
-- 1) Billing plans (canonical catalog: free / team / business)
-- =============================================================================
INSERT INTO public.billing_plans (
  code, name, description, price_cents, currency, interval,
  max_users, max_projects, features, active, sort_order
) VALUES
  (
    'free', 'Free', 'Get started',
    0, 'USD', 'month', 3, 5,
    '["Up to 5 projects","1 admin","Community support"]'::jsonb,
    true, 1
  ),
  (
    'team', 'Team', 'Growing teams',
    4900, 'USD', 'month', 10, NULL,
    '["Unlimited projects","10 users","Email support"]'::jsonb,
    true, 2
  ),
  (
    'business', 'Business', 'Enterprise-ready',
    19900, 'USD', 'month', NULL, NULL,
    '["Unlimited users","SSO","Priority support","White-label"]'::jsonb,
    true, 3
  )
...
-- =============================================================================
-- 2) Landing config singleton (brand + hero so Platform → Landing is not empty)
-- App still merges DEFAULT_LANDING for any missing keys.
-- =============================================================================
INSERT INTO public.landing_config (id, config)
VALUES (
  'singleton',
  jsonb_build_object(
    ...
    'hero', jsonb_build_object(
      ...
      'subtitle', 'One PMO command center for live portfolio KPIs, resource timesheets, stage-gate governance, optional SSO & BYOD, and Jira integrations.',
...
ON CONFLICT (id) DO UPDATE SET
  config = CASE
    WHEN public.landing_config.config IS NULL
      OR public.landing_config.config = '{}'::jsonb
      OR NOT (public.landing_config.config ? 'brand')
    THEN EXCLUDED.config
    ELSE public.landing_config.config
  END,
  updated_at = now();

-- =============================================================================
-- 3) Invoice template singleton (matches src/lib/invoice-template DEFAULT_*)
-- =============================================================================
INSERT INTO public.invoice_template_config (id, config)
VALUES (
  'singleton',
  jsonb_build_object(
    ...
    'payment_instructions', 'Please arrange payment by the due date. Reference the invoice number on your remittance.',
...
ON CONFLICT (id) DO UPDATE SET
  config = CASE
    WHEN public.invoice_template_config.config IS NULL
      OR public.invoice_template_config.config = '{}'::jsonb
      OR NOT (public.invoice_template_config.config ? 'company_name')
    THEN EXCLUDED.config
    ELSE public.invoice_template_config.config
  END,
  updated_at = now();

-- =============================================================================
-- 4) Legal policies (stubs) + full iProjectX bodies
-- =============================================================================
...
-- Ensure all policies are published for /legal/:slug
UPDATE public.legal_policies
SET published = true,
    updated_at = now()
WHERE published = false;
...
-- =============================================================================
-- 5) Platform expenses (sample COGS — only when table is empty)
-- =============================================================================
INSERT INTO public.platform_expenses (category, description, amount_cents, currency, expense_date, vendor, recurring, notes)
SELECT * FROM (VALUES
  ('Infrastructure', 'Supabase Pro', 59900, 'USD', (CURRENT_DATE - 10), 'Supabase', true, 'Platform baseline seed'),
  ('Infrastructure', 'Vercel Pro', 20000, 'USD', (CURRENT_DATE - 10), 'Vercel', true, 'Platform baseline seed'),
  ('Tooling', 'GitHub Team', 21000, 'USD', (CURRENT_DATE - 15), 'GitHub', true, 'Platform baseline seed'),
  ('Marketing', 'Launch ads (sample)', 80000, 'USD', (CURRENT_DATE - 5), 'Google', false, 'Platform baseline seed')
) AS v(category, description, amount_cents, currency, expense_date, vendor, recurring, notes)
WHERE NOT EXISTS (SELECT 1 FROM public.platform_expenses LIMIT 1);

-- =============================================================================
-- 6) Scale partition plan (ops roadmap — disabled by default; skip if DDL missing)
-- =============================================================================
DO $$
BEGIN
  IF to_regclass('public.scale_partition_plan') IS NULL THEN
    RAISE NOTICE 'scale_partition_plan missing — skip';
    RETURN;
  END IF;
  INSERT INTO public.scale_partition_plan (table_name, strategy, partition_key, notes, enabled)
  VALUES
...
-- =============================================================================
-- 7) Subscriptions for every existing organisation (Business plan)
-- =============================================================================
...
FROM public.organizations o
CROSS JOIN LATERAL (
  SELECT id FROM public.billing_plans WHERE code = 'business' AND active LIMIT 1
) p
WHERE NOT EXISTS (
  SELECT 1 FROM public.subscriptions s WHERE s.org_id = o.id
);

-- Align organizations.plan text with attached subscription when blank / free
UPDATE public.organizations o
SET plan = COALESCE(NULLIF(o.plan, ''), 'business')
WHERE EXISTS (
  SELECT 1
  FROM public.subscriptions s
  JOIN public.billing_plans bp ON bp.id = s.plan_id
  WHERE s.org_id = o.id AND bp.code = 'business'
)
AND (o.plan IS NULL OR o.plan IN ('', 'free', 'trial'));

-- =============================================================================
-- 8) Sample invoices (one paid current-period invoice per org that has none)
-- =============================================================================
INSERT INTO public.invoices (
  org_id, subscription_id, invoice_number, amount_cents, currency, status,
  issue_date, due_date, paid_date, period_start, period_end, notes, line_items
)
SELECT
  s.org_id,
  s.id,
  'INV-BASE-' || to_char(CURRENT_DATE, 'YYYYMM') || '-' || substr(replace(o.id::text, '-', ''), 1, 6),
  COALESCE(bp.price_cents, 19900),
  ...
  'Baseline seed — ' || COALESCE(bp.name, 'Business') || ' subscription',
  jsonb_build_array(
    jsonb_build_object(
      'description', COALESCE(bp.name, 'Business') || ' plan (' || COALESCE(bp.interval, 'month') || ')',
      'quantity', 1,
      'unit_amount_cents', COALESCE(bp.price_cents, 19900),
      'amount_cents', COALESCE(bp.price_cents, 19900)
    )
  )
FROM public.subscriptions s
...
LEFT JOIN public.billing_plans bp ON bp.id = s.plan_id
WHERE NOT EXISTS (
  SELECT 1 FROM public.invoices i WHERE i.org_id = s.org_id
);
...
SELECT
  ...
  i.amount_cents,
  i.currency,
  COALESCE(i.paid_date::timestamptz, now() - INTERVAL '3 days'),
  'manual',
  'platform-baseline-seed'
FROM public.invoices i
WHERE i.notes LIKE 'Baseline seed —%'
  AND NOT EXISTS (SELECT 1 FROM public.invoice_payments p WHERE p.invoice_id = i.id);

-- Optional: billing email on orgs that have none (uses first org_admin profile email)
UPDATE public.organizations o
SET billing_email = p.email
FROM (
  SELECT DISTINCT ON (pr.org_id) pr.org_id, pr.email
  FROM public.profiles pr
  JOIN public.user_roles ur ON ur.user_id = pr.id AND ur.org_id = pr.org_id
  WHERE pr.email IS NOT NULL
    AND ur.role IN ('org_admin', 'platform_admin', 'admin')
  ORDER BY pr.org_id, CASE ur.role
...
WHERE o.id = p.org_id
  AND (o.billing_email IS NULL OR btrim(o.billing_email) = '');

-- =============================================================================
-- 9) Org support settings (defaults for orgs that have none; skip if DDL missing)
-- =============================================================================
DO $$
BEGIN
  IF to_regclass('public.org_support_settings') IS NULL THEN
    RAISE NOTICE 'org_support_settings missing — skip';
    RETURN;
  END IF;
  INSERT INTO public.org_support_settings (org_id)
  SELECT o.id
  FROM public.organizations o
  WHERE NOT EXISTS (
    SELECT 1 FROM public.org_support_settings s WHERE s.org_id = o.id
  );
END $$;
...
-- Done — verification
-- =============================================================================
SELECT 'billing_plans' AS entity, count(*)::text AS n FROM public.billing_plans
UNION ALL SELECT 'legal_policies', count(*)::text FROM public.legal_policies
UNION ALL SELECT 'landing_config', count(*)::text FROM public.landing_config
UNION ALL SELECT 'invoice_template_config', count(*)::text FROM public.invoice_template_config
UNION ALL SELECT 'platform_expenses', count(*)::text FROM public.platform_expenses
...
UNION ALL SELECT 'org_support_settings',
  CASE WHEN to_regclass('public.org_support_settings') IS NULL THEN 'n/a'
       ELSE (SELECT count(*)::text FROM public.org_support_settings) END
UNION ALL SELECT 'scale_partition_plan',
  CASE WHEN to_regclass('public.scale_partition_plan') IS NULL THEN 'n/a'
       ELSE (SELECT count(*)::text FROM public.scale_partition_plan) END
ORDER BY 1;

SELECT code, name, price_cents, max_users, max_projects, active
FROM public.billing_plans
ORDER BY sort_order;

SELECT o.name AS org, o.slug, bp.code AS plan, s.status, s.current_period_end
FROM public.subscriptions s
JOIN public.organizations o ON o.id = s.org_id
LEFT JOIN public.billing_plans bp ON bp.id = s.plan_id
ORDER BY o.name;
